...
class NERBaseAnnotator(pl.LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.AdamW(
            [
                ...
                {"params": self.feedforward.parameters(), "lr":self.lr_decoder},
    ...
    def perform_forward_step(self, batch, mode=''):
        ...
        output = output = self._compute_token_tags(token_scores=token_scores, mask=mask, tags=tags, metadata=metadata, batch_size=batch_size, mode=mode)
